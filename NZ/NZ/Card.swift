...
struct Card: Decodable, Encodable {
    ...
    /// Array of Card objects for Most Likely To deck.
    static var MLT : [Card] {
    [Card(prompt: "Most likely to become famous."), Card(prompt: "Most likely to go skydiving."), Card(prompt: "Most likely to be alone forever."), Card(prompt: "Most likely to miss class for a sleep-in."), Card(prompt: "Most likely to donate to charity."), Card(prompt: "Most likely to fight a police officer."), Card(prompt: "Most likely to burn down the house while cooking."), Card(prompt: "Most likely to forget their best friends birthday."), Card(prompt: "Most likely to flake out with a dumb excuse."), Card(prompt: "Most likely to dye their hair."), Card(prompt: "Most likely to get a face tattoo.")]
    }
